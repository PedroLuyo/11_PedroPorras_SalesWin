...
CREATE TABLE VENTA (
	...
	IDVEND int,
	IDCLI int,
	TIPPAGVEN char(1) CHECK(TIPPAGVEN ='T' OR TIPPAGVEN ='E' OR TIPPAGVEN ='Y' OR TIPPAGVEN ='P'), 
...
create table PERSONA (	
	...
	NOMPER varchar(80) NOT NULL CHECK(NOMPER LIKE '%[a-zA-Z ]'),
	APEPER varchar(80) NOT NULL CHECK(APEPER LIKE '%[a-zA-Z ]'),
	CELPER char(9) NOT NULL UNIQUE,
	EMAPER varchar(150) NOT NULL UNIQUE,
	FECNACPER date CHECK (DATEDIFF(year,FECNACPER,GETDATE()) >= 18),
...
CREATE TABLE PRODUCTO (
	CODPRO char(3) NOT NULL UNIQUE CHECK(CODPRO LIKE '[P][0-9][0-9]'), 
	NOMPRO varchar(100) NOT NULL,
	TIPPRO char(1) NOT NULL CHECK(TIPPRO='T' OR TIPPRO='V' OR TIPPRO='P' OR TIPPRO='W'),
	VOLPRO char(3) NOT NULL CHECK(VOLPRO='500' OR VOLPRO='250' OR VOLPRO='750'),
	PREPRO decimal(8,2) NOT NULL,
	STOPRO int NOT NULL,
	PAIPRO char(1) NOT NULL CHECK(PAIPRO='A' OR PAIPRO='P' OR PAIPRO='C' OR PAIPRO='M'  OR PAIPRO='E'),
